...
function idFetcher(sequelize, nodeTypeMapper) {
  return (() => {
    var ref = (0, _bluebird.coroutine)(function* (globalId, context) {
...
function sequelizeConnection(_ref) {
  let name = _ref.name;
  let nodeType = _ref.nodeType;
  let target = _ref.target;
  let orderByEnum = _ref.orderBy;
  let _before = _ref.before;
  let connectionFields = _ref.connectionFields;
  let edgeFields = _ref.edgeFields;
  ...
  let $resolver = require('./resolver')(target, {
    ...
    after: (() => {
      var ref = (0, _bluebird.coroutine)(function* (values, args, context, _ref2) {
        ...
        if ((args.first || args.last) && (fullCount === null || fullCount === undefined)) {
          ...
          fullCount = yield target.count(source, {
        ...
        if (args.first || args.last) {
          ...
          if (args.last) {
            var _ref3 = [hasPreviousPage, hasNextPage];
            hasNextPage = _ref3[0];
            hasPreviousPage = _ref3[1];
          }
        }
